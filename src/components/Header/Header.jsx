...
const Header = () => {
    return (
        <div className="hero min-h-[540px] bg-base-200 px-24 rounded-3xl mt-6 md:mt-12 mb-12 md:mb-24">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <figure>
                    <img className='mx-auto w-[90%] md:w-full' src= {user} />
                </figure>
                <div className='max-w-[526px]   flex flex-col'>
                    <h1 className="text-3xl md:text-5xl font-bold mb-6 md:mb-12">Books to freshen up your bookshelf</h1>
